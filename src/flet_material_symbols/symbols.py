...
class _SymbolsIconData(IconData, package_name="material_symbols_icons", class_name="Symbols"):
    _DUMMY = -1
...
_SymbolsIconData.__name__ = "Symbols"
_SymbolsIconData.__qualname__ = "Symbols"
...
class _SymbolsProxy:
    ...
    def __init__(self) -> None:
        ...
        self._values: list[_SymbolsIconData] | None = None
    ...
    def _get_member(self, name: str) -> _SymbolsIconData:
        self._load()
    ...
    def _get_values(self) -> list[_SymbolsIconData]:
        self._load()
